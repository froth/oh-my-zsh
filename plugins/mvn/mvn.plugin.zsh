...
function listMavenCompletions { 
	...
	# tomee
        ...
        # options
        -Dmaven.test.skip=true -DskipTests -DskipITs -Dmaven.surefire.debug -DenableCiProfile -Dpmd.skip=true -Dcheckstyle.skip=true -Dfindbugs.skip=true -Dtycho.mode=maven
